"""autogenerated by genpy from reefbot_msgs/ImageCaptured.msg. Do not edit."""
import sys
...
class ImageCaptured(genpy.Message):
  _md5sum = "2a14011e5d0ce053cbc95beb961ecdae"
  _type = "reefbot_msgs/ImageCaptured"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# This message specifies that a still image was captured by the system.
#
...
"""
  __slots__ = ['header','image_id','image']
  _slot_types = ['std_msgs/Header','uint64','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ImageCaptured, self).__init__(*args, **kwds)
