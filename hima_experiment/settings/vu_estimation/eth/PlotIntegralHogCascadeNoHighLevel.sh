...
OUTPUT_DIR=/data/mdesnoye/pedestrian/vu_estimation/eth/integral_hog_cascade/graphs_no_high_level
INPUT_DIR=/data/mdesnoye/pedestrian/vu_estimation/eth/integral_hog_cascade_no_high_level
...
for model in ${MODELS[*]}; do
    src/CascadeAccuracy.py \
        ...
        --output_data ${OUTPUT_DIR}/IntegralHOGCascadeETHNoHigh_${dataset}_${model}.stats \
        --estimator_regex "vu_cascade_IntegralHOGCascadeETHNoHigh_${dataset}_([0-9A-Za-z]+)\.bag" \
        --valid_vutype ${model} \
