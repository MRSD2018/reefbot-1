...
MODEL_DIR=/data/mdesnoye/pedestrian/eth/integral_cascade_30k

OUTPUT_DIR=/data/mdesnoye/pedestrian/vu_estimation/eth/integral_hog_cascade/cross_30k
...
for modelFile in ${MODEL_DIR}/*0.07.xml ; do
