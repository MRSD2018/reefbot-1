#!/bin/sh
OUTPUT_DIR=/data/mdesnoye/pedestrian/vu_estimation/hima/graphs/30step_nocache/
...
--skip_scaling \
--skip_resampling \
--hog_timing_file /data/mdesnoye/pedestrian/vu_estimation/hima/hog/hog_timing_full.txt \
