...
OUTPUT_DIR=/data/mdesnoye/pedestrian/vu_estimation/hima/integral_hog_cascade/graphs_no_high_level
INPUT_DIR=/data/mdesnoye/pedestrian/vu_estimation/hima/integral_hog_cascade_no_high_level/
...
for model in ${MODELS[*]}; do
    src/CascadeAccuracy.py \
        ...
        --output_data ${OUTPUT_DIR}/IntegralHOGCascadeNoHighLevel_${dataset}_${model}.stats \
