...
OUTPUT_DIR=/data/mdesnoye/hima/experiments/cat/stereo_left1
INPUT_DIRS=(/data/mdesnoye/hima/cat/stereo_left1 \
)
...
--person_thresh 0 \--frame_estimator HighRelativeEntropy \
--morph_close_size 4 \
--gauss_sigma 5 \
--min_entropy "[0.05]" \
--frame_expansion "[1.2]" \
