...
OUTPUT_DIR=/data/mdesnoye/fish/extractedFish/blob090710/allLabDescriptors/
PARAMS="--random_detector --random_frac 0.005 --color_descriptor --color_converter CV_BGR2LAB"
SUFFIX=lab
