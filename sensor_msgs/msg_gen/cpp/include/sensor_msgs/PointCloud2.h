/* Auto-generated by genmsg_cpp for file /home/mdesnoyer/src/reefbot/ros/sensor_msgs/msg/PointCloud2.msg */
...
{
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::PointCloud2_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::PointCloud2_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< const ::sensor_msgs::PointCloud2_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
