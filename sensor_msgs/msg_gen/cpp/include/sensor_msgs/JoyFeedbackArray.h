/* Auto-generated by genmsg_cpp for file /home/mdesnoyer/src/reefbot/ros/sensor_msgs/msg/JoyFeedbackArray.msg */
...
struct JoyFeedbackArray_ {
  ...
  std::vector< ::sensor_msgs::JoyFeedback_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::sensor_msgs::JoyFeedback_<ContainerAllocator> >::other >  array;
...
{
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::JoyFeedbackArray_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::JoyFeedbackArray_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
