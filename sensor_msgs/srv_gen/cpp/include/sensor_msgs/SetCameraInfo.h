/* Auto-generated by genmsg_cpp for file /home/mdesnoyer/src/reefbot/ros/sensor_msgs/srv/SetCameraInfo.srv */
#ifndef SENSOR_MSGS_SERVICE_SETCAMERAINFO_H
#define SENSOR_MSGS_SERVICE_SETCAMERAINFO_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
{
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::SetCameraInfoRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::SetCameraInfoRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::sensor_msgs::SetCameraInfoResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
#endif // SENSOR_MSGS_SERVICE_SETCAMERAINFO_H
